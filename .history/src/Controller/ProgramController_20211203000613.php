...
class ProgramController extends AbstractController
{
    ...
    /**
     * @Route("{programId}/season/{seasonNumber}/episode/{episodeNumber}", name="episode_show")
     * @ParamConverter("program", class="App\Entity\Program", options={"mapping": {"programId": "id"}})
     * @ParamConverter("season", class="App\Entity\Season", options={"mapping": {"seasonNumber": "id"}})
     * @ParamConverter("episode", class="App\Entity\Episode", options={"mapping": {"episodeNumber": "id"}})
     */
    public function showEpisode(Program $programId, Season $seasonNumber, Episode $episodeNumber)
    {
        return $this->render('episode/show.html.twig', ['program' => $programId, 'season' => $seasonNumber, 'episode' => $episodeNumber]);
    }
