...
class ProgramController extends AbstractController
{
    ...
    /**
     * @Route("{programId}/season/{season_id}/episode/{episodeId}", name="episode_show")
     * @ParamConverter("program", class="App\Entity\Program", options={"mapping": {"programId": "id"}})
     * @ParamConverter("season", class="App\Entity\Season", options={"mapping": {"season_id": "id"}})
     * @ParamConverter("episode", class="App\Entity\Episode", options={"mapping": {"episodeId": "id"}})
     */
    public function showEpisode(Program $programId, Season $season_id, Episode $episodeId): Response
    {
        return $this->render('episode/show.html.twig', ['program' => $programId, 'season' => $season_id, 'episode' => $episodeId]);
    }
