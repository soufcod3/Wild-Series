...
class ProgramController extends AbstractController
{
     ...
     */
    public function showSeason(Program $program1, Season $season1): Response
    {
        return $this->render('season/show.html.twig', ['program' => $program1, 'season' => $season1]);
     ...
     */
    public function showEpisode(Program $program2, Season $season2, Episode $episode2): Response
    {
        return $this->render('episode/show.html.twig', ['program' => $program2, 'season' => $season2, 'episode' => $episode2]);
    }
