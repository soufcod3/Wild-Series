...
class ProgramController extends AbstractController
{
     ...
     */
    public function showEpisode(Program $programId, Season $seasonNumber, Episode $episode)Id: Response
    {
        return $this->render('episode/show.html.twig', ['program' => $programId, 'season' => $seasonNumber, 'episode' => $episode]);
    }
