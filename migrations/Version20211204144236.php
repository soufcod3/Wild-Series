 ...
 */
final class Version20211204144236 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE episode_program (episode_id INT NOT NULL, program_id INT NOT NULL, INDEX IDX_18E483F7362B62A0 (episode_id), INDEX IDX_18E483F73EB8070A (program_id), PRIMARY KEY(episode_id, program_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE episode_program ADD CONSTRAINT FK_18E483F7362B62A0 FOREIGN KEY (episode_id) REFERENCES episode (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE episode_program ADD CONSTRAINT FK_18E483F73EB8070A FOREIGN KEY (program_id) REFERENCES program (id) ON UPDATE NO ACTION ON DELETE CASCADE');
